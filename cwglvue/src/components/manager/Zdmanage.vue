...
export default {
 ...
 data() {
    ...
    methods: {
         init(){
        this.$axios.post("/account/selecAccountInfoByuserId2", JSON.stringify(this.query), {
            headers: {
          ...
          this.query.userId = this.getCookie('user').userId
          // alert(JSON.stringify(res.data.query))
        })
      },
